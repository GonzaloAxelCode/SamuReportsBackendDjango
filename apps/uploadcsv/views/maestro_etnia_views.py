...
from apps.uploadcsv.models import MAESTRO_HIS_ETNIA
from apps.uploadcsv.serializers import MAESTRO_HIS_ETNIASerializer
...
class MAESTRO_HIS_ETNIA_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_ETNIA()
        identifier_field = "Id_Etnia"
        try:
           #leer
...
class MAESTRO_HIS_ETNIA_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_ETNIA.objects.all()
    serializer_class = MAESTRO_HIS_ETNIASerializer
