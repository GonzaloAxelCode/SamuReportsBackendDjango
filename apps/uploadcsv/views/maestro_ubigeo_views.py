...
from apps.uploadcsv.models import MAESTRO_HIS_UBIGEO_INEI_RENIEC
from apps.uploadcsv.serializers import MAESTRO_HIS_UBIGEO_INEI_RENIECSerializer
...
class MAESTRO_HIS_UBIGEO_INEI_RENIEC_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_UBIGEO_INEI_RENIEC()
        identifier_field = "Id_Ubigueo_Inei"
        try:
           #leer
...
class MAESTRO_HIS_UBIGEO_INEI_RENIEC_Delete_View(APIView):
   permission_classes = [AllowAny]
   def delete(self, request):
        with connection.cursor() as cursor:

            table_name =  MAESTRO_HIS_UBIGEO_INEI_RENIEC._meta.db_table
            cursor.execute(
...
class MAESTRO_HIS_UBIGEO_INEI_RENIEC_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_UBIGEO_INEI_RENIEC.objects.all()
    serializer_class = MAESTRO_HIS_UBIGEO_INEI_RENIECSerializer
