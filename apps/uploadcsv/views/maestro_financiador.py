...
from apps.uploadcsv.models import MAESTRO_HIS_FINANCIADOR
from apps.uploadcsv.serializers import MAESTRO_HIS_FINANCIADOR_Serializer
...
class MAESTRO_HIS_FINANCIADOR_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_FINANCIADOR()
        identifier_field = "Id_Financiador"
        try:
           #leer
...
class MAESTRO_HIS_FINANCIADOR_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_FINANCIADOR.objects.all()
    serializer_class = MAESTRO_HIS_FINANCIADOR_Serializer
