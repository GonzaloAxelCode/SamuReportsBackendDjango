...
from apps.uploadcsv.models import MAESTRO_HIS_COLEGIO
from apps.uploadcsv.serializers import MAESTRO_HIS_COLEGIO_Serializer
...
class MAESTRO_HIS_COLEGIO_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_COLEGIO()
        identifier_field = "Id_Colegio"
        try:
           #leer
...
class MAESTRO_HIS_COLEGIO_List_View(generics.ListAPIView):

        queryset = MAESTRO_HIS_COLEGIO.objects.all()
        serializer_class= MAESTRO_HIS_COLEGIO_Serializer
