...
from apps.uploadcsv.models import MAESTRO_HIS_COLEGIO, MAESTRO_HIS_PROFESION
from apps.uploadcsv.serializers import MAESTRO_HIS_PROFESION_Serializer
...
class MAESTRO_HIS_PROFESION_CSV_View(APIView, FileValidationMixin):
...
class MAESTRO_HIS_PROFESION_List_View(generics.ListAPIView):
    

    
    queryset = MAESTRO_HIS_PROFESION.objects.all()
    serializer_class = MAESTRO_HIS_PROFESION_Serializer
