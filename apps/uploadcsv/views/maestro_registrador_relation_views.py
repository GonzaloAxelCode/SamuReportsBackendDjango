...
from apps.uploadcsv.models import MAESTRO_HIS_REGISTRADOR, MAESTRO_HIS_TIPO_DOC
from apps.uploadcsv.serializers import MaestroRegistradorSerializer
...
class MAESTRO_HIS_REGISTRADOR_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = model()
        identifier_field = "Id_Registrador"
        ...
        try:
            ...
            dataframe.clean_data(columns_to_string=["Fecha_Nacimiento"])
...
class MAESTRO_HIS_REGISTRADOR_List_View(generics.ListAPIView):
    

    queryset = MAESTRO_HIS_REGISTRADOR.objects.all()
    serializer_class= MaestroRegistradorSerializer
