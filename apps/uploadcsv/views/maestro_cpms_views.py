...
from apps.uploadcsv.models import MAESTRO_HIS_CIE_CPMS
from apps.uploadcsv.serializers import MAESTRO_HIS_CIE_CPMSSerializer
...
class MAESTRO_HIS_CIE_CPMS_CSV_View(APIView, FileValidationMixin):
...
class MAESTRO_HIS_CIE_CPMS_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_CIE_CPMS.objects.all()
    serializer_class = MAESTRO_HIS_CIE_CPMSSerializer
