...
from apps.uploadcsv.models import MAESTRO_HIS_UPS
from apps.uploadcsv.serializers import UpsSerializer
...
class MAESTRO_HIS_UPS_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_UPS()
        identifier_field = "Id_Ups"
        try:
           # leer
...
class MAESTRO_HIS_UPS_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_UPS.objects.all()
