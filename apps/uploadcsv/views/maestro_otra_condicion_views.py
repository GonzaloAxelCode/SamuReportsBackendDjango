...
from apps.uploadcsv.models import MAESTRO_HIS_OTRA_CONDICION
from apps.uploadcsv.serializers import MAESTRO_HIS_OTRA_CONDICION_Serializer
...
class MAESTRO_HIS_OTRA_CONDICION_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_OTRA_CONDICION()
        identifier_field = "Id_Otra_Condicion"
        try:
           #leer
...
class MAESTRO_HIS_OTRA_CONDICION_Delete_View(APIView):
   permission_classes = [AllowAny]
   def delete(self, request):
        with connection.cursor() as cursor:
            # Trunca la tabla para eliminar todos los registros y reiniciar los contadores de secuencia
            table_name =  MAESTRO_HIS_OTRA_CONDICION._meta.db_table
            cursor.execute(
...
class MAESTRO_HIS_OTRA_CONDICION_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_OTRA_CONDICION.objects.all()
    serializer_class = MAESTRO_HIS_OTRA_CONDICION_Serializer
