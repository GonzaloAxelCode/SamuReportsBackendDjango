...
from apps.uploadcsv.models import MAESTRO_HIS_CENTRO_POBLADO
from apps.uploadcsv.serializers import MAESTRO_HIS_CENTRO_POBLADOSerializer
...
class MAESTRO_HIS_CENTRO_POBLADO_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_CENTRO_POBLADO()
        identifier_field = "Id_Centro_Poblado"
        try:
           #leer
...
class MAESTRO_HIS_CENTRO_POBLADO_Delete_View(APIView):
  
   permission_classes = [AllowAny]
   def delete(self, request):
        with connection.cursor() as cursor:
            # Trunca la tabla para eliminar todos los registros y reiniciar los contadores de secuencia
            table_name =  MAESTRO_HIS_CENTRO_POBLADO._meta.db_table
            cursor.execute(
...
class MAESTRO_HIS_CENTRO_POBLADO_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_CENTRO_POBLADO.objects.all()
    serializer_class = MAESTRO_HIS_CENTRO_POBLADOSerializer
