...
from apps.uploadcsv.models import MAESTRO_HIS_TIPO_DOC
from apps.uploadcsv.serializers import MAESTRO_HIS_TIPO_DOC_Serializer
...
class MAESTRO_HIS_TIPO_DOC_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_TIPO_DOC()
        identifier_field = "Id_Tipo_Documento"
        try:
           #leer
...
class MAESTRO_HIS_TIPO_DOC_List_View(generics.ListAPIView):
    


    queryset = MAESTRO_HIS_TIPO_DOC.objects.all()
        
    serializer_class= MAESTRO_HIS_TIPO_DOC_Serializer
