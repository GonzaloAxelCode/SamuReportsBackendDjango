...
from apps.uploadcsv.models import MAESTRO_HIS_PAIS
from apps.uploadcsv.serializers import MAESTRO_HIS_PAIS_Serializer
...
class MAESTRO_HIS_PAIS_CSV_View(APIView, FileValidationMixin):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_PAIS()
        identifier_field = "Id_Pais"
        try:
           #leer
...
class MAESTRO_HIS_PAIS_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_PAIS.objects.all()
    serializer_class = MAESTRO_HIS_PAIS_Serializer
