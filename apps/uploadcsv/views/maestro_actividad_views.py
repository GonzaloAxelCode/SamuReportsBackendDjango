...
from apps.uploadcsv.models import MAESTRO_HIS_ACTIVIDAD_HIS
from apps.uploadcsv.serializers import MaestroHisActividadHisSerializer
...
class MAESTRO_HIS_ACTIVIDAD_HIS_CSV_View(APIView):
    ...
    def post(self, request):
        ...
        instance = MAESTRO_HIS_ACTIVIDAD_HIS()
        identifier_field = "Id_Actividad_His"
        try: 
             #leer
...
class MAESTRO_HIS_ACTIVIDAD_HIS_Delete_View(APIView):
   permission_classes = [AllowAny]
   def delete(self, request):
        with connection.cursor() as cursor:
            table_name =  MAESTRO_HIS_ACTIVIDAD_HIS._meta.db_table
            cursor.execute(
...
class MAESTRO_HIS_ACTIVIDAD_HIS_List_View(generics.ListAPIView):

    queryset = MAESTRO_HIS_ACTIVIDAD_HIS.objects.all()
    serializer_class = MaestroHisActividadHisSerializer
